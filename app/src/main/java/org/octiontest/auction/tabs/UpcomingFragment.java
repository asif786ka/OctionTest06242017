...
public class UpcomingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        lvOction = (ListView) rootView.findViewById(R.id.lvMovies);
    ...
    public class JSONTask extends AsyncTask<String,String, List<OctionModel> >{
        ...
        protected List<OctionModel> doInBackground(String... params) {
            ...
            try {
                ...
                for(int i=0; i<parentObject.length(); i++) {
                    ...
                    octionModel = new OctionModel();
                    octionModel.setImage(image);
                    octionModel.setTitle(title);
                    octionModel.setProductPrice(price);
                    movieModelList.add(octionModel);
        ...
        protected void onPostExecute(final List<OctionModel> result) {
            ...
            dialog.dismiss();
            if(result != null) {
                OctionAdapter adapter = new OctionAdapter(getActivity(), R.layout.upcomingrow, result);
                lvOction.setAdapter(adapter);
            } else {
    ...
    public class OctionAdapter extends ArrayAdapter{

        private List<OctionModel> movieModelList;
        private int resource;
        private LayoutInflater inflater;
        public OctionAdapter(Context context, int resource, List<OctionModel> objects) {
